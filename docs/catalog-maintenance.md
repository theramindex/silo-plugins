...
```json
{
  ...
  "checksums_url": "https://github.com/theramindex/silo-plugins/releases/download/v0.1.4/checksums.txt",
  "binaries": {
    "linux/amd64": {
      "url": "https://github.com/theramindex/silo-plugins/releases/download/v0.1.4/plugin-linux-amd64-silo-plugin-local-metadata",
      "checksum": "<linux-amd64-binary-sha256>"
    }
  }
}
